...
namespace LarpPortal.Reports
{
    public partial class CheckIn : System.Web.UI.Page
    {
        ...
        private void Bindgrid()
        {
            ...
            DataTable dtCheckList = Classes.cUtilities.LoadDataTable("uspRptCheckIn", sParams, "LARPortal", Master.UserName, lsRoutineName + ".uspRptCheckIn");
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=CheckIn.csv");
            Response.Charset = "";
