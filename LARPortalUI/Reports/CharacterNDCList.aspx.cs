...
{
    public partial class CharacterNDCList : System.Web.UI.Page
    {
        ...
        private void Bindgrid()
        {
            ...
            sParams.Add("@NDCCategory", 0);
            sParams.Add("@CampaignID", Master.CampaignID);


        DataTable dtAttributes = Classes.cUtilities.LoadDataTable("uspRptCharacterNDCs", sParams, "LARPortal", Master.UserName, lsRoutineName + ".uspRptCharacterNDCs");

            gvAttributes.DataSource = dtAttributes;
        ...
        protected void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            gvAttributes.AllowPaging = false;
            gvAttributes.DataBind();
