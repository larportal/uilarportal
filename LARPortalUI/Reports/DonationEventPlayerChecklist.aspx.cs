...
{
    public partial class DonationEventPlayerChecklist : System.Web.UI.Page
    {
        ...
        private void Bindgrid()
        {
            ...
            sParams.Add("@CampaignPlayerID", 0);
            sParams.Add("@UserID", Master.UserID);
            DataTable dtCheckList = Classes.cUtilities.LoadDataTable("uspRptDonationEventByPlayer", sParams, "LARPortal", Master.UserName, lsRoutineName + ".uspRptDonationEventByPlayer");
