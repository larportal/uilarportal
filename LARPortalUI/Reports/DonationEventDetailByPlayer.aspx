<%@ Page Title="" Language="C#" MasterPageFile="~/LARPortal.Master" AutoEventWireup="true" CodeBehind="DonationEventDetailByPlayer.aspx.cs" Inherits="LarpPortal.Reports.DonationEventDetailByPlayer" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="header-background-image">
                    <h1>Donation Event Items By Player</h1>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Donation Event Items By Player</div>
