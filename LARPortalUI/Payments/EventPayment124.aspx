<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="EventPayment124.aspx.cs" Inherits="LarpPortal.Payments.EventPayment124" %>
<!DOCTYPE html>
                ...
                <form id="frmHidFields124" runat="server">
                    <div role="form" class="form-horizontal">
                        <div class="col-sm-12 NoPadding">
                            <h1 class="col-sm-12">Coventry - Event Registration Payment</h1>
                        </div>
                                ...
                                <div class="panel NoPadding" style="padding-top: 0px; padding-bottom: 0px; min-height: 50px;">
                                    ...
                                    <div class="panel-body NoPadding">
                                        <div class="panel-container NoPadding">
                                            <asp:Label ID="lblPageText" runat="server" Text="See Coventry page for current event fees."></asp:Label>
