<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="EventPayment1349.aspx.cs" Inherits="LarpPortal.Payments.EventPayment1349" %>
<!DOCTYPE html>
    ...
    <div class="contentArea">
        ...
        <div class="mainContent tab-content col-lg-6 input-group">
            <section id="campaign-info" class="campaign-info tab-pane active">
                <form id="frmHidFields124" runat="server">
                    <div role="form" class="form-horizontal">
                        <div class="col-sm-12 NoPadding">
                            <h1 class="col-sm-12">Resurgence LARP - Event Registration Payment</h1>
                        </div>
                                ...
                                <div class="panel NoPadding" style="padding-top: 0px; padding-bottom: 0px; min-height: 50px;">
                                    ...
                                    <div class="panel-body NoPadding">
                                        <div class="panel-container NoPadding">
                                            <asp:Label ID="lblPageText" runat="server" Text="See Resurgence page (https://resurgencelarp.org/payment/) for current event fees."></asp:Label>
