<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventPayment7.aspx.cs" Inherits="LarpPortal.Payments.EventPayment80" %>
                ...
                <form id="frmHidFields" runat="server">
                    <div role="form" class="form-horizontal">
                        <div class="col-sm-12 NoPadding">
                            <h1 class="col-sm-12">Cottington Woods 2 - Event Registration Payment</h1>
                        </div>
