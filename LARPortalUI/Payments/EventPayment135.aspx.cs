...
{
    public partial class EventPayment135 : System.Web.UI.Page
    {
                ...
                else
                {
                    ...
                    else
                    {
                        foreach (DataRow dRow in dtPaymentPageCode.Rows)
                        {
                            ...
                            if (EarlyPay == true)
                            {
                                lblPayPalForm.Text += "<input name=\"amount\" type=\"hidden\" value=\"75.00\" />";
                                lblEarlyOrLate.Text = "Anomaly Event (Preregistration)";
                            }
                            else
                            {
                                lblPayPalForm.Text += "<input name=\"amount\" type=\"hidden\" value=\"85.00\" />";
                                lblEarlyOrLate.Text = "Anomaly Event";
                            }
