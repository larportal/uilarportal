<%@ Page Title="" Language="C#" MasterPageFile="~/LARPortal.Master" AutoEventWireup="true" CodeBehind="DonationEdit.aspx.cs" Inherits="LarpPortal.Donations.DonationEdit" %>
...
<asp:Content ID="DonationEditBody" ContentPlaceHolderID="MainBody" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><asp:Label ID="lblEvent" runat="server"></asp:Label></div>
