...
namespace LarpPortal.Calendar
{
	public partial class MonthCalendar : System.Web.UI.Page
	{
		...
		protected void Page_PreRender(object sender, EventArgs e)
		{
			...
			//while (icounter < 1)
			//{
			//	string t = "<table><tr><td>Event Name</td><td>1/1/2000</td></tr>" +
			//		"<tr><td>Start</td><td>5/1/2016</td></tr></table>";
			//	eventstring = eventstring + "{     title: '" + DateList[icounter].EventName + "', tooltip: '" +
			//		t + "', textEscape: false,    start:  '" + string.Format("{0:yyyy-MM-dd}", DateTime.Today) +
			//		// DateList [icounter].DateValue) + 
			//		"'  } ";
			//	icounter++;
			//}

			//foreach (DateWithDescription oDate in DateList)
			//{
			//	eventstring = eventstring + "{     title: '<b>" + oDate.EventName + "</b>',   start:  '" + string.Format("{0:yyyy-MM-dd}", oDate.DateValue) + "'  },";
			//}
